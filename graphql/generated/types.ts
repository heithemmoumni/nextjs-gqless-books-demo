 ...
 * @type OBJECT
 */
type t_Book = FieldsType<
  {
    __typename: t_String<"Book">;
    id: t_ID;
    title?: t_String | null;
    author: t_Author;
  },
 ...
 * @type OBJECT
 */
type t_Author = FieldsType<
  {
    __typename: t_String<"Author">;
    id: t_ID;
    name: t_String;
  },
  Extension<"Author">
 ...
 * @type OBJECT
 */
export type Book = TypeData<t_Book>;
 ...
 * @type OBJECT
 */
export type Author = TypeData<t_Author>;
